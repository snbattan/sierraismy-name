...
import { DisneyIcon, NikeIcon, OregonIcon, ResumeSection } from '.';

const experiences = [
  {
    icon: <DisneyIcon />,
    id: 'Disney Senior',
    other: ['TypeScript', 'Next.js', 'React', 'Node.js', 'Kubernetes', 'Java'],
  ...
  },
  {
    icon: <NikeIcon />,
    id: 'Nike FTE II',
    other: ['JavaScript', 'Next.js', 'React', 'Node.js', 'AWS'],
